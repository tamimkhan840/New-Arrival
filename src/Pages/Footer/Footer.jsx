            ...
            <footer className="relative z-10 bg-black text-white pb-10 pt-20 dark:bg-dark lg:pb-10 lg:pt-[50px] mt-8">
                    ...
                    <div className="flex flex-wrap ">
                        <div className="max-w-[250px] px-4">
                            <div className="w-full mb-10">
                                <a href="/#" className="mb-6 inline-block max-w-[60px]">
                                    <img
                                        src={logo}
                                        alt="logo"
                        ...
                        <LinkGroup header="Support">
                            ...
                            <NavLink link="/#" label="hmdtamimkhan@gmail.com" />
                ...
                <footer className="container m-4 mx-auto rounded-lg shadow ">
                    <div className="w-full max-w-screen-xl p-4 mx-auto md:flex md:items-center md:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">Tamim khan™</a>. All Rights Reserved.
                        </span>
