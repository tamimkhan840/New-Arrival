  ...
  return (
	...
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
		<div className="max-w-md text-center">
			...
			<Link to={'/'} rel="noopener noreferrer"  className="px-8 py-3 font-semibold rounded bg-rose-500 dark:bg-violet-600 text-gray-900 dark:text-gray-50">Back to homepage</Link>
		</div>
	</div>
</section>
  )
